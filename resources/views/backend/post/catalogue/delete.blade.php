            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa ngôn ngữ có tên là: {{ $postCatalogue->name }}</p> 
                        <p>Lưu ý: Không thể khôi phục ngôn ngữ sau khi xóa. Hãy chắc chắn bạn muốn thực hiện chức năng này<span class="text-danger">(*)</span></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input type="text" value="{{ old('name', ($post.catalogue->name) ?? '') }}" 
